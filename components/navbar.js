  ...
  <div>
    <nav className="bg-white px-2 sm:px-4 py-2.5 dark:bg-gray-900 w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
      <div className="container flex flex-wrap items-center justify-between mx-auto">
        ...
        <ul className={
            toggle
              ? "px-2 hover:text-blue-700 block md:hidden p-4 fixed top-[60px] bg-gray-800 w-full h-screen duration-500 left-0 inset-0 bg-opacity-30 backdrop-blur-sm"
              : "px-2 hover:text-blue-700 block md:hidden p-4 fixed top-[60px] bg-gray-800 w-full h-screen duration-500 left-[-100%]"
          }>
          <li>
